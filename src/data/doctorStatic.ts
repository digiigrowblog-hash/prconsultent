// Static metadata about doctors: images, description, fallback names & specialization

export const staticDoctorMeta = [
    {
...
best teacher as well as the best mentor.`,
    },
    {
        ...
        description: `Dr Shoaib Padaria graduated from the Seth G S Medical College in Mumbai 
...
Angioplasty and Angiography, including Diabetic Foot.`,
    },
    {
        ...
        fallbackSpecialization:"Spine Surgeon,Orthopedist and Joint Replacement Surgeon",
            description:`Dr. Manish Sontakke is a Spine Surgeon,Orthopedist and Joint Replacement Surgeon in Fortis Hiranandani
             hospital vashi and has an experience of 12 years in these fields. He completed MBBS from Mahatma Gandhi Institute of Medical
              Sciences, Sewagram (MGIMS) in 2000,DNB-Orthopaedics /Orthopedic Surgery 
